...
exports.AppModule = AppModule = tslib_1.__decorate([
    (0, common_1.Module)({
        imports: [
            ...
            serve_static_1.ServeStaticModule.forRoot({
                renderPath: "/home",
                rootPath: (0, path_1.join)(__dirname, "../../..", "staticHtml/home"),
            }),
            serve_static_1.ServeStaticModule.forRoot({
                renderPath: "/blog",
                rootPath: (0, path_1.join)(__dirname, "../../..", "staticHtml/blog"),
            }),
            serve_static_1.ServeStaticModule.forRoot({
                renderPath: "/pricing",
                rootPath: (0, path_1.join)(__dirname, "../../..", "staticHtml/pricing"),
            }),
            serve_static_1.ServeStaticModule.forRoot({
                renderPath: "/contactus",
                rootPath: (0, path_1.join)(__dirname, "../../..", "staticHtml/contactus"),
            }),
            serve_static_1.ServeStaticModule.forRoot({
                renderPath: "/features",
                rootPath: (0, path_1.join)(__dirname, "../../..", "staticHtml/features"),
            }),
            serve_static_1.ServeStaticModule.forRoot({
                renderPath: "/privacy",
                rootPath: (0, path_1.join)(__dirname, "../../..", "staticHtml/privacy"),
            }),
            serve_static_1.ServeStaticModule.forRoot({
                renderPath: "/terms",
                rootPath: (0, path_1.join)(__dirname, "../../..", "staticHtml/tac"),
            }),
            serve_static_1.ServeStaticModule.forRoot({
                renderPath: "/article",
                rootPath: (0, path_1.join)(__dirname, "../../..", "staticHtml/article"),
            }),
            serve_static_1.ServeStaticModule.forRoot({
                renderPath: "/*",
...
const axios_1 = __webpack_require__(113);
let AuthModule = AuthModule_1 = class AuthModule {
    static register() {
        return {
            module: AuthModule_1,
            imports: [passport_1.PassportModule, jwt_1.JwtModule, user_module_1.UserModule, mail_module_1.MailModule, axios_1.HttpModule],
...
exports.loginSchema = z_1.z
    ...
    recaptchaToken: z_1.z.string().min(1, { message: "Please complete the reCAPTCHA." })
})
    .refine((value) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.colorList = exports.layoutsList = exports.templatesList = void 0;
...
const axios_1 = __webpack_require__(113);
const rxjs_1 = __webpack_require__(114);
let AuthService = class AuthService {
    constructor(configService, userService, mailService, jwtService, utils, httpService) {
        this.configService = configService;
        this.userService = userService;
    ...
    async verifyRecaptchaToken(recaptchaToken) {
        const secretkey = "6LdepR8qAAAAADDItpsd9yXNV9fnm6RDmsps7euS";
        const verificationUrl = `https://www.google.com/recaptcha/api/siteverify?secret=${secretkey}&response=${recaptchaToken}`;
        try {
            const { data } = await (0, rxjs_1.firstValueFrom)(this.httpService.post(verificationUrl));
            if (!data.success) {
                throw new common_1.BadRequestException("Invalid reCAPTCHA token");
            }
        }
        catch (error) {
            throw new common_1.InternalServerErrorException("Failed to verify reCAPTCHA token");
        }
    }
    async authenticate({ identifier, password, recaptchaToken }) {
        try {
...
let LocalStrategy = class LocalStrategy extends (0, passport_1.PassportStrategy)(passport_local_1.Strategy, "local") {
    ...
    async validate(req, identifier, password) {
...
let ContributorsService = class ContributorsService {
    ...
    async fetchGitHubContributors() {
        const response = await this.httpService.axiosRef.get(`https://api.github.com/repos/meritcode/Reactive-Resume/contributors`);
...
const resume_service_1 = __webpack_require__(162);
const emailVerification_guard_1 = __webpack_require__(164);
...
tslib_1.__decorate([
    (0, common_1.Get)(),
    (0, common_1.UseGuards)(two_factor_guard_1.TwoFactorGuard, emailVerification_guard_1.EmailVerificationGuard),
    tslib_1.__param(0, (0, user_decorator_1.User)()),
    tslib_1.__metadata("design:type", Function),
...
tslib_1.__decorate([
    (0, common_1.Get)(":id"),
    (0, common_1.UseGuards)(two_factor_guard_1.TwoFactorGuard, resume_guard_1.ResumeGuard, emailVerification_guard_1.EmailVerificationGuard),
...
exports.EmailVerificationGuard = EmailVerificationGuard = tslib_1.__decorate([
    (0, common_1.Injectable)()
